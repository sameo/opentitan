...
#ifndef OPENTITAN_HW_TOP_DARJEELING_SW_DEVICE_SILICON_CREATOR_ROM_ROM_ISRS_H_
#define OPENTITAN_HW_TOP_DARJEELING_SW_DEVICE_SILICON_CREATOR_ROM_ROM_ISRS_H_
...
#endif  // OPENTITAN_HW_TOP_DARJEELING_SW_DEVICE_SILICON_CREATOR_ROM_ROM_ISRS_H_
